...
* <code>AICollab_DB_funcs.R</code> 
		...
		* <code>insert_resuts(RESULTSTABLE, ids_AGENT, ids_TASK, ids_METHOD)</code> # Insert RESULTSTABLE in RESULT (need ids generated by the previous functions)
		

* <code>AICollab_DB_populate.R</code>
		* <code>insert_Atlas(SOURCETABLE, AGENTTABLE, METHODTABLE, TASKTABLE, RESULTSTABLE)</code> # Insert SOURCETABLE
